...
{
    $data = array();
    $whereVal = " where team_member_status='Active'";
    if(isset($_REQUEST['project_id']) and $_REQUEST['project_id']!='' and !isset($_REQUEST['activity_id']))
    {
        $whereVal .=" and project_id = '".$_REQUEST['project_id']."' and activity_id IS NULL";
    }
