...
//ini_set('max_execution_time', '300');//done
//ini_set('memory_limit', '96M'); //done
					...
					<h3>Key Documents</h3>
						...
						<div class="project_doc form_blk">
							...
							<fieldset>
								  ...
								  <button class="usa-button-outline reset_form" type="button" id="reset_btn">Cancel</button>
								  <button class="usa-button-active" type="button" id="submit_form">Save</button>
								  <div class="clear"></div>
							</fieldset>
						</div>
						</form>
						...
						<tr>
							...
							<td class="text-center"> 
								 <form method="post" class="form-inline disp-inline">
									...
									<a class="btn btn-danger remove_document"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
								 </form> 
							</td>
						</tr>
					</tbody>
