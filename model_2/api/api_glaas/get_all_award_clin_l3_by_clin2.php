...
## request for get all Clin l3 by clin l2============
if(isset($_REQUEST['clin_l2_number']) and $_REQUEST['clin_l2_number']!='')
{   
    $data = array();
    ...
    $select_data = "select * from usaid_requisition_award_clin where parent_clin_number='".$clin_l2_number."' and level=3 ".$cond."";
