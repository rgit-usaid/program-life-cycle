...
{
	$url = API_HOST_URL."get_all_clin_l2_by_clin1.php?flag=1&clin_l1_number=".$clin_l1_number;
...
{
	$edit_clin_number = $_REQUEST['edit_clin_number'];
	removeRequisitionClin_l2($edit_clin_number);
	header("location:clin_l2.php");
}
				...
				<div class="col-md-6">
					<div class="container-fluid" id="manage-vendor">
						<div class="form-title" style="width:145px;">
							<i class="fa fa-minus" aria-hidden="true"></i>CLIN - L2
						</div>
							...
							<div class="manage-info">	
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l2_arr['data'])){$share = $clin_l2_arr['data']['share'];}
					  ...
					  <?php } ?>					
								...
								<div class="form-group">
									<div class="col-md-6">
										<h5 class="pull-right"><a href="clin_l1.php">Back to CLIN L1</a></h5>
									</div>
									<div class="col-md-6">
										<a href="clin_l2.php" class="btn btn-default" style="margin-right:25px;">Cancel</a>
...
<div class="container-fluid">
	<table id="manage-parent-table" class="table table-striped" border="2" style="" cellspacing="0" width="100%">
		...
		<tbody>
			...
			{
				for($k=0; $k<count($requisition_clin_l2_arr['data']); $k++)
				{
					$url = API_HOST_URL."get_all_budget_of_clin.php?clin_number=".$requisition_clin_l2_arr['data'][$k]['clin_number'];
					$clin_budget_arr = requestByCURL($url);
					
					$url = API_HOST_URL."get_link_to_by_requisition.php?requisition_number=".$requisition_clin_l2_arr['data'][$k]['clin_number'];
					$list_assoc_link_arr = requestByCURL($url);
					?>	
					<tr class="parent-tbl parent-link">
						<td class="text-center"><span onClick="showClinTwo(this)" class="btn action" title="Level-2"> <img src="images/plus.png"></span> <?php echo $requisition_clin_l2_arr['data'][$k]['clin_number']; ?></td>
						<td class="text-center"><?php echo $requisition_clin_l2_arr['data'][$k]['clin_name']; ?></td>
						<td class="text-center"><?php echo $requisition_clin_l2_arr['data'][$k]['clin_description']; ?></td>
						<td class="text-right"><?php echo '$'.number_format($requisition_clin_l2_arr['data'][$k]['clin_amount']); ?></td>
						<td class="text-center"><?php echo $requisition_clin_l2_arr['data'][$k]['start_performance_period']; ?></td>
						<td class="text-center"><?php echo $requisition_clin_l2_arr['data'][$k]['end_performance_period']; ?></td>
								...
								<ul class="list-inline" style="">
									<li>
										<form method="post" action="">
											<input type="hidden" name="edit_clin_number" value="<?php echo $requisition_clin_l2_arr['data'][$k]['clin_number'];?>">			
									...
									<li>
										<form method="post" action="clin_l3.php" class="form-inline"> 
											<input type="hidden" name="clin_l1_number" value="<?php echo $clin_l1_number; ?>">
											<input type="hidden" name="clin_l2_number" value="<?php echo $requisition_clin_l2_arr['data'][$k]['clin_number'];?>">
											<input type="hidden" name="requisition_number" value="<?php echo $requisition_number;?>">

											<button type="submit" class="btn btn-default action" data-toggle="tooltip" data-placement="top" title="CLIN - L3" style="margin:0 2px; color:#000; font-size: 12px; text-decoration:none" >CLIN - L3</button>
										</form>
									</li>									
								</ul>
							</div>			
					...
					<tr class="child-clin2 disp-none">
												<td colspan="9">
													<div style="padding:10px;">
														...
														$url = API_HOST_URL."get_all_clin_l3_by_clin2.php?clin_l2_number=".$requisition_clin_l2_arr['data'][$k]['clin_number'];
														...
														{	
															...
															?>
																	<tr class="child-clin3">										
																		<td><span onClick="showClinThree(this)" class="btn action" title="Level-3"> <img src="images/plus.png"></span> <?php echo $requisition_clin_l3_arr['data'][$m]['clin_number']; ?></td>
