...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $data = array();
    $select_fund_transaction = "select t.*,ou.operating_unit_abbreviation,ou.operating_unit_description,td1.ledger_type_id ,td1.credit_amount,td1.debit_amount,ou1.operating_unit_abbreviation as debit_from,ou1.operating_unit_description as debit_from_description
                            ...
                            where td1.ledger_type='Operating Unit' and td2.ledger_type='Operating Unit' and ou.type='Bureau' and ou1.type!='Bureau' and td1.credit_amount is not null and td1.ledger_type_id='".$ledger_type_id."' ".$cond." group by t.id ";
