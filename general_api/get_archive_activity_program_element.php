...
if(isset($_REQUEST['archive_id']))
{
	...
	while($fetch_program_element = $result_program_element->fetch_array()){
		 ...
		 $data[$i]['added_on'] = $fetch_program_element['added_on'];  
		 $i++; 
	}
	if(count($data)>0){
