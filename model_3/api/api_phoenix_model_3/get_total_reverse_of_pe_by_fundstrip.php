...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $select_fund_transaction = "select t.*,f.fund_name,f.fund_id as fund_code,td1.ledger_type_id ,sum(td1.debit_amount) as total_debit_amount,td2.ledger_type_id as origination_point
                        ...
                        where td1.ledger_type='Program Element' and td2.ledger_type='Fund' and td1.debit_amount is not null and td1.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' ".$cond."  group by td1.ledger_type_id";
