...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $select_fund_transaction = "select t.*,td1.ledger_type_id ,td1.credit_amount,td1.debit_amount,td2.ledger_type_id as ledger_type_id_dr
                        ...
                        where td1.ledger_type='".$ledger_type."' and td1.ledger_type_id='".$ledger_type_id."' and td1.fund_status='Obligate' and t.fund_id='".$fund_id."' and program_element_id='".$pe_id."'  ".$cond."  group by t.id ";
