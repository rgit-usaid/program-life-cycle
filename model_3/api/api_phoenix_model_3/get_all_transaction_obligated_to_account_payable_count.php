...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
	...
	$select_fund_transaction = "select t.*,sum(td2.debit_amount) as total_amount
                        ...
                        where td2.ledger_type='Award CLIN' and td2.fund_status='Obligate' and td2.debit_amount is not null and td2.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td1.fund_status='Paid' ".$cond."  group by td2.ledger_type_id "; 
