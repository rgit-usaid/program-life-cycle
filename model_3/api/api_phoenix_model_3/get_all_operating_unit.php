...
if(isset($_REQUEST['name']) and $_REQUEST['name']!='')
{
    ...
    $cond = " and ( operating_unit_description like '%".$name."%' or operating_unit_abbreviation like '%".$name."%')";
}
$data = array();
$select_operating_unit = "select * from usaid_operating_unit where type!='Organization'".$cond; 
