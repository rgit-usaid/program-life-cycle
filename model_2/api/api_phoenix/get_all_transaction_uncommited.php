...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
   ...
   $select_fund_transaction = "select t.*,ou.operating_unit_abbreviation as origination_point,ou.operating_unit_description,td2.ledger_type_id,td2.ledger_type,sum(td2.debit_amount) as total_debit_amount,td1.debit_amount,td2.fund_status
                        ...
                        where  td1.ledger_type='Operating Unit' and ou.type!='Bureau' and td2.ledger_type='".$ledger_type."' and td2.debit_amount is not null  and td2.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' ".$cond."  group by t.id";
