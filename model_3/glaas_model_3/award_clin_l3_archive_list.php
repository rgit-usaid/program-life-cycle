...
## get id archive award clin level-3 for archive details================
if($_REQUEST['archive_clin_l3_id']!='')
{
	$archive_clin_l3_id = $_REQUEST['archive_clin_l3_id'];
	$_SESSION['archive_clin_l3_id'] = $archive_clin_l3_id;
}
else
{
	$archive_clin_l3_id = $_SESSION['archive_clin_l3_id'];
}
	$url = API_HOST_URL."get_all_archive_award_clin_detail.php?archive_clin_id=".$archive_clin_l3_id;
...
<div class="container-fluid" id="form-requisiton">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-right btnstyle"> <a href="award_clin_l3.php">
      <button type="button" class="btn btn-primary back_button">Back to Award Clin -L-3</button>
      </a> </div>
  </div>
                ...
                <form class="form-horizontal" role="form" method="post" action="">
                  <div class="col-md-6">
                    <div class="container-fluid" id="manage-vendor">
                      <div class="form-title" style="width:200px;"> <i class="fa fa-minus" aria-hidden="true"></i>AWARD CLIN - L3 </div>
