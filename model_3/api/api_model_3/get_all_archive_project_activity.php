...
if(isset($_REQUEST['project_id']) && isset($_REQUEST['activity_id']))
{
    ...
    $select_archive_project_activity = "select pa.*
                        from usaid_archive_project_activity as pa where pa.project_id = '".$project_id."' and pa.activity_id = '".$activity_id."' order by archive_on desc";
	...
	$i=0; 
     while($fetch_archive_project_activity = $result_archive_project_activity->fetch_array())
		...
		$data[$i]['archive_on'] = $fetch_archive_project_activity['archive_on'];  
