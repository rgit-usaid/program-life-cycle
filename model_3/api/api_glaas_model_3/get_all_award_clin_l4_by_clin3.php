...
## request for get all Clin l4 by clin l3============
if(isset($_REQUEST['clin_l3_number']) and $_REQUEST['clin_l3_number']!='')
{   
    $data = array();
    ...
    $select_data = "select * from usaid_requisition_award_clin where parent_clin_number='".$clin_l3_number."' and level=4 ".$cond."";
