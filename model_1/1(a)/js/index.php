			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:40px; margin-bottom:150px">
						...
						<div style="width:50%; float:left; text-align:left">
							<div style="padding:50px 10px; background:white; width:400px; display:inline-block;font-size:35px; box-shadow:2px 2px 4px #333;color:#5b616b">
								<div class="text-center"> <span>Committed Fund </span><br/><span style="color:#205493;font-weight:bold">$ 3.2 b</span></div>
							</div>
						</div>
						<div style="width:50%; float:left; text-align:left">
							<div style="padding:50px 10px; background:white; width:400px; display:inline-block;font-size:35px;box-shadow:2px 2px 4px #333;color:#5b616b">
								<div class="text-center"> <span>Obligated Fund </span><br/><span style="color:#205493;font-weight:bold">$ 2.6 b</span></div>
							</div>
						</div>
						<div class="clear"></div>
					</div>
