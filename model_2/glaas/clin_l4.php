...
### show in header============================================================
	...
	$url = API_HOST_URL."get_clin_detail.php?clin_number=".$clin_l3_number;
...
if(isset($_REQUEST['edit_clin_l4']))
{
	...
	### get all budget of a clin level 4===========
	...
	## get all assoc link for clin level 4 =======	
...
{
	$edit_clin_number = $_REQUEST['edit_clin_number'];
	removeRequisitionClin_l4($edit_clin_number);
	header("location:clin_l4.php");
}
				...
				<thead>
					<tr>
						<th colspan="6">
							<ul class="list-inline">
								<li>CLIN - L3</li>
								<li class="pull-right">( <a href="clin_l3.php">Back to CLIN - L3</a> )</li>
							</ul>
						</th>
					</tr>
				</thead>
			...
			<div class="col-md-6">
				<div class="container-fluid" id="manage-vendor">
					<div class="form-title" style="width:145px;">
						<i class="fa fa-minus" aria-hidden="true"></i>CLIN - L4
					</div>
					<div class="new-form-content">
						<div class="manage-info">				
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l4_arr['data'])){$share = $clin_l4_arr['data']['share'];}
					  ...
					  <?php } ?>					
								...
								<div class="form-group">
									<div class="col-md-6">
										<h5 class="pull-right"><a href="clin_l3.php">Back to CLIN L3</a></h5>
									</div>
									<div class="col-md-6">
										<a href="clin_l4.php" class="btn btn-default" style="margin-right:25px;">Cancel</a>
...
<div class="container-fluid">
	<table id="manage-parent-table" class="table table-striped" border="2" style="" cellspacing="0" width="100%">
		...
		{
			for($k=0; $k<count($requisition_clin_l4_arr['data']); $k++)
			{
				$url = API_HOST_URL."get_all_budget_of_clin.php?clin_number=".$requisition_clin_l4_arr['data'][$k]['clin_number'];
				$clin_budget_arr = requestByCURL($url);
				
				$url = API_HOST_URL."get_link_to_by_requisition.php?requisition_number=".$requisition_clin_l4_arr['data'][$k]['clin_number'];
				$list_assoc_link_arr = requestByCURL($url);
				?>	
				<tr class="parent-tbl parent-link">
					<td class="text-center"><?php echo $requisition_clin_l4_arr['data'][$k]['clin_number']; ?></td>
					<td class="text-center"><?php echo $requisition_clin_l4_arr['data'][$k]['clin_name']; ?></td>
					<td class="text-center"><?php echo $requisition_clin_l4_arr['data'][$k]['clin_description']; ?></td>
					<td class="text-right"><?php echo '$'.number_format($requisition_clin_l4_arr['data'][$k]['clin_amount']); ?></td>
					<td class="text-center"><?php echo $requisition_clin_l4_arr['data'][$k]['start_performance_period']; ?></td>
					<td class="text-center"><?php echo $requisition_clin_l4_arr['data'][$k]['end_performance_period']; ?></td>
					...
					<td class="text-center"> 
						...
						<ul class="list-inline" style="">
							...
							<form method="post" action="">
								<input type="hidden" name="edit_clin_number" value="<?php echo $requisition_clin_l4_arr['data'][$k]['clin_number'];?>">			
