...
if(isset($_REQUEST['archive_evaluation_id']))
{
    ...
    $select_archive_project_evalution = "select * from usaid_archive_project_evaluation where evalution_id = '".$archive_evaluation_id."' order by archive_on desc";
	...
	while($fetch_archive_evaluation = $result_archive_project_evalution->fetch_array()){
			...
			$data[$i]['archive_evalution_id'] = $fetch_archive_evaluation['evalution_id'];
