...
if(isset($_REQUEST['edit_evaluation']) && isset($_REQUEST['project_id']) && $_REQUEST['project_id']!=""){
	...
	$estimated_cost = "$".number_format($project_evaluation_arr['data']['estimated_cost']);
				...
				<div class="form-blk"> 
					...
					<div class="form-blk">
						<div class="review_listing_blk">
							<header><h3 class="form-blk-head">Project Evaluation List</h3></header>
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<table class="table table-bordered review-listing table-striped">
										...
										<tr class="no_row_found">
											<td colspan="7" class="bold text-danger">No evaluation found for this project</td>
										</tr>
										<?php }?>
									</table>
								</div>
