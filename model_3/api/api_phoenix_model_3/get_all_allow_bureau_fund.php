...
$data = array();
$select_fund_transaction = "select t.*,ou.operating_unit_abbreviation,ou.operating_unit_description,td1.ledger_type_id ,td1.credit_amount,td1.debit_amount,td2.ledger_type_id as origination_point
                        ...
                        where td1.ledger_type='Operating Unit' and td2.ledger_type='Fund' and ou.type='Bureau'  and td1.credit_amount is not null and related_transaction is null group by t.id ";
