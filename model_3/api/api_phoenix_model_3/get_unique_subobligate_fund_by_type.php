...
if(isset($_REQUEST['ledger_type_id']))
{
    ...
    $select_operating_unit = "SELECT t.*,f.fund_id as fund_code 
                            ...
                            WHERE td.ledger_type_id='".$ledger_type_id."' and td.ledger_type='".$ledger_type."' and (td.fund_status='Subobligate' or td.fund_status='Obligate') and td.credit_amount is not null 
