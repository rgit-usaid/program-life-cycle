...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $ledger_type_id_dr = trim($_REQUEST['ledger_type_id_dr']);
    ...
    $data = array();
    $select_fund_transaction = "select t.*,concat(ou.operating_unit_abbreviation) as movement_to,td1.ledger_type_id ,sum(td1.credit_amount) as total_amount,ou1.operating_unit_abbreviation as debit_from,concat(ou1.operating_unit_abbreviation,'(',ou1.operating_unit_description,')') as movement_from,t.program_element_id
                            ...
                            where td1.ledger_type='Operating Unit' and td2.ledger_type='Operating Unit' and ou.type='Bureau' and ou1.type!='Bureau' and td1.credit_amount is not null and td1.ledger_type_id='".$ledger_type_id."' and td2.ledger_type_id='".$ledger_type_id_dr."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' ".$cond." group by td2.ledger_type_id"; 
