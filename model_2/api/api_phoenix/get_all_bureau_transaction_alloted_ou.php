...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $select_fund_transaction = "select t.*,ou.operating_unit_abbreviation,ou.operating_unit_description,td1.ledger_type_id , td2.debit_amount ,ou1.operating_unit_abbreviation as debit_from
                        ...
                        where td2.ledger_type='Operating Unit' and td2.debit_amount is not null and td1.ledger_type='Operating Unit'and td2.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and program_element_id='".$pe_id."' and ou.type!='Bureau' and ou1.type='Bureau' ".$cond."  group by ".$gp_by." "; 
