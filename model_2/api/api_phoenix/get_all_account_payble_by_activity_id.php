...
{   
	...
	$select_data = "select acpd.invoice_paid as total_paid_amount, acp.invoice_date as invoice_date,  
	acpd.invoice_amt as total_invoice_amt
	FROM usaid_account_payble acp
	LEFT JOIN usaid_account_payble_detail acpd ON acpd.acc_payable_id = acp.id
	WHERE acpd.activity_id='".$activity_id."'";
