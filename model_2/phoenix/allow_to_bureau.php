...
<!-- help popup section end-->
	...
	<!--help icon section-->
      <div class="col-sm-offset-9 col-sm-3 text-right" style="float:right;height:20px;"><img src="images/information.png" class="pointer_help" title="Click to view help allow to Bureau"></div>
