			...
			if(count($all_requisition_award_arr['data'])>0)
			{
				for($k=0; $k<count($all_requisition_award_arr['data']); $k++)
				{
					...
					<tr class="parent-tbl parent-link">
						<td class="text-center"><span onClick="showClinOne(this)" class="btn action" title="Level-1"> <img src="images/plus.png"></span> <?php echo $all_requisition_award_arr['data'][$k]['award_number'];?></td>
