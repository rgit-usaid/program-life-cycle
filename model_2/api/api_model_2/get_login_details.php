...
if(isset($_REQUEST['user_email']))
{
	...
	$select_employee = "select employee_id, USAID_email,first_name,last_name,picture from usaid_employee WHERE USAID_email ='".$user_email."'";
	...
	if($fetch_employee['USAID_email'] == $user_email)
	{
		...
		$data['first_last_name'] = $fetch_employee['first_name'].' '.$fetch_employee['last_name']; 			 			
