...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
   ...
   $select_fund_transaction = "select t.*,td1.ledger_type_id ,sum(td2.debit_amount) as total_debit_amount ,td2.ledger_type_id as origination_point,f.fund_name,f.fund_id
                        ...
                        where td2.ledger_type='Fund' and td2.debit_amount is not null and td1.ledger_type='Program Element'  and td2.ledger_type_id='".$ledger_type_id."' ".$cond." group by td2.ledger_type_id "; 
