...
<body>
	...
	<div class="container-fluid">
		<ol class="breadcrumb">
			<li><a href=".">Home</a> &raquo; <a href="existing_project.php">Existing Project</a> &raquo; <a href="activity_list.php">Edit Activity Info</a> &raquo;  <a class="active">Activity Team</a></li>
		</ol>
		<!-- Left Menu -->
		<div class="col-md-3">
	...
	<script>
		$('input[type="radio"][name="manage_team_member"]').click(function(){
			if($(this).val()=="add_team_member"){
				window.location = "add_activity_team_member.php";
			}
			else if($(this).val()=="edit_team_member"){
				window.location = "edit_activity_team_member.php";
			}
			else if($(this).val()=="archive_team_member"){
				window.location = "archive_activity_team_member.php";
			}
		});
