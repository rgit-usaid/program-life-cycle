	...
	<div class="main-container container-fluid" id="main-content">
		<div>
			...
			<div class="tbl-block">
				...
				<div class="tbl-content-head">Geo Coding Archive</div>
		...
		<a href="add_project_geo_location.php"><button type="button" class="btn btn-primary back_button">Back to  Geo Coding</button></a>
		    ...
		    <table id="projects_table" class="display table table-bordered table-striped" cellspacing="0" width="100%">
					...
					if(count($archive_geo_arr['data'])>0)
					{
						...
						{  ?>
						<tr>
							<td align="center"><?php echo dateTimeFormat($archive_geo_arr['data'][$k]['archive_on']);  ?></td>
						...
						<tr class="disp-none">
							<td colspan="3">
								 <div class="project-detail-blk table-container">
									<div id="submission_msg" class="form-msg "></div>
									<div class="form-blk">
										<div class="form-blk">
											<div class="row">
											...
											<div class="row location_list">
												 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													?>		
														<tr>
															<td> 
																<?php if($archive_project_geo_location_arr['data'][$i]['project_activity_id']=="" && $archive_project_geo_location_arr['data'][$i]['impacted_area']=="No"){?>
																...
																<?php }?><?php echo $archive_project_geo_location_arr['data'][$i]['address']; ?>
																</td>
