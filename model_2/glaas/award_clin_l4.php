...
unset($_SESSION['archive_clin_l4_id']);
...
##generate CLIN number by CLIN 3=========
function generateClinNumber($clin_l3_number)
{
	$url = API_HOST_URL."get_all_award_clin_l4_by_clin3.php?flag=1&clin_l3_number=".$clin_l3_number;
	$clin_arr = requestByCURL($url);
	$total_count = count($clin_arr['data']);
	$total_count  = $total_count + 1;
	$last_number = sprintf("%03d",$total_count);
	$clin_number = $clin_l3_number.'-'.$last_number;
	return $clin_number;
}
...
if(isset($_REQUEST['award_number']))
{
	...
	$clin_l3_number = trim($_REQUEST['clin_l3_number']);
	$_SESSION['clin_l3_number'] = $clin_l3_number;
}
else{
	...
	$clin_l3_number = $_SESSION['clin_l3_number'];
}

## add/edit clin level 4 ============
if(isset($_REQUEST['save_clin_l4']))
{
	...
	else
	{
		if($clin_id=='')
		{
			...
			parent_clin_number='".$clin_l3_number."',   
			level='".$level."'";
			...
			header("location:award_clin_l4.php");
		}
		else
		{
...
### get header details or clin level 4 details for listing=======
if($award_number!='')
{
	...
	$url = API_HOST_URL."get_award_clin_detail.php?clin_number=".$clin_l2_number;
	$clin_l2_arr = requestByCURL($url);

	$url = API_HOST_URL."get_award_clin_detail.php?clin_number=".$clin_l3_number;
	...
	$clin_number = generateClinNumber($clin_l3_number);	
}

## edit clin level 4 =================
$flag = 0;
if(isset($_REQUEST['edit_clin_l4']))
{
...
## delete_clin_l4 =================
if(isset($_REQUEST['delete_clin_l4']))
{
	$edit_clin_number = $_REQUEST['edit_clin_number'];
	removeAwardClin_l4($edit_clin_number);
	header("location:award_clin_l4.php");  
}
?>
<!DOCTYPE html>
	...
	<div class="top-menu">
		...
		<header class="container-fluid" id="requisition-detail">
			<div class="table-responsive">
				...
				<thead>
					<tr>
						<th colspan="6">
							<ul class="list-inline">
								<li>Award CLIN - L2</li>
								<li class="pull-right">( <a href="award_clin_l2.php">Back to Award CLIN - L2</a> )</li>
							</ul>
						</th>
					</tr>
				</thead>
				...
				<thead>
					<tr>
						<th colspan="6">
							<ul class="list-inline">
								<li>Award CLIN - L3</li>
								<li class="pull-right">( <a href="award_clin_l3.php">Back to Award CLIN - L3</a> )</li>
							</ul>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<th>CLIN Number:</th><td><?php echo $clin_l3_arr['data']['clin_number']?></td> 
						<th>CLIN Name:</th>	<td><?php echo $clin_l3_arr['data']['clin_name']?></td> 
						<th>CLIN Description:</th><td> <?php echo $clin_l3_arr['data']['clin_description']?></td> 
					</tr>
					<tr>
						<th>CLIN Amount:</th><td><?php echo '$'.number_format($clin_l3_arr['data']['clin_amount']);?></td> 
						<th>CLIN Start Performance Period:</th>	<td><?php echo $clin_l3_arr['data']['start_performance_period']?></td> 
						<th>CLIN End Performance Period:</th><td><?php echo $clin_l3_arr['data']['end_performance_period']?></td> 
					</tr>
				</tbody>
			</table>
		</div>		
	...
	<div class="container-fluid">
		<table id="manage-parent-table" class="table table-striped" border="2" style="" cellspacing="0" width="100%">
			...
			<tbody>
				...
				{
					for($k=0; $k<count($award_clin_l4_arr['data']); $k++)
					{
						$url = API_HOST_URL."get_all_budget_of_clin.php?clin_number=".$award_clin_l4_arr['data'][$k]['clin_number'];
						$clin_budget_arr = requestByCURL($url);
						
						$url = API_HOST_URL."get_link_to_by_requisition.php?requisition_number=".$award_clin_l4_arr['data'][$k]['clin_number'];
						$list_assoc_link_arr = requestByCURL($url);
						?>	
						<tr class="parent-tbl parent-link">
							<td class="text-center"><?php echo $award_clin_l4_arr['data'][$k]['clin_number']; ?></td>
							<td class="text-center"><?php echo $award_clin_l4_arr['data'][$k]['clin_name']; ?></td>
							<td class="text-center"><?php echo $award_clin_l4_arr['data'][$k]['clin_description']; ?></td>
							<td class="text-right"><?php echo '$'.number_format($award_clin_l4_arr['data'][$k]['clin_amount']); ?></td>
							<td class="text-center"><?php echo $award_clin_l4_arr['data'][$k]['start_performance_period']; ?></td>
							<td class="text-center"><?php echo $award_clin_l4_arr['data'][$k]['end_performance_period']; ?></td>
									...
									<ul class="list-inline" style="">
										<li>
											<form method="post" action="">
												<input type="hidden" name="edit_clin_number" value="<?php echo $award_clin_l4_arr['data'][$k]['clin_number'];?>">
												<button type="submit" name="edit_clin_l4" class="btn btn-success action" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></button>
												<button type="submit" name="delete_clin_l4" class="btn btn-danger action" data-toggle="tooltip" data-placement="top" title="Remove" onClick="return window.confirm('Are you sure you want to remove this?');"><i class="fa fa-times" aria-hidden="true"></i></button>
											...
											<?php 
											$url = API_HOST_URL."get_all_archive_award_clin_detail.php?archive_clin_id=".$award_clin_l4_arr['data'][$k]['clin_id'];
											 $archive_award_req_arr = requestByCURL($url); if(count($archive_award_req_arr['data'])>0) { ?>
											<a href="award_clin_l4_archive_list.php?archive_clin_l4_id=<?php echo $award_clin_l4_arr['data'][$k]['clin_id'];?>">Change Log</a>
	...
	<div class="container-fluid" id="form-requisiton">
		<div class="row">
			<form class="form-horizontal" role="form" method="post" action="">			
				<input type="hidden" name="clin_id" value="<?php echo $clin_l4_arr['data']['clin_id'];?>">
				<div class="col-md-6">
					<div class="container-fluid" id="manage-vendor">
						<div class="form-title" style="width:200px;">
							<i class="fa" aria-hidden="true"></i>AWARD CLIN - L4
						</div>
						<div class="new-form-content">
							<div class="manage-info"> 
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l4_arr['data'])){$clin_name = $clin_l4_arr['data']['clin_name'];}
										?>		
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l4_arr['data'])){$clin_description = $clin_l4_arr['data']['clin_description'];}
										?>								
								...
								<div class="form-group">
									...
									<div class="col-md-6">							
										...
										if(isset($clin_l4_arr['data'])){$clin_amount = '$'.number_format($clin_l4_arr['data']['clin_amount']);}
										?>	
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<div class="input-group">
											...
											if(isset($clin_l4_arr['data'])){$start_performance_period = $clin_l4_arr['data']['start_performance_period'];}
											?>								
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<div class="input-group">
											...
											if(isset($clin_l4_arr['data'])){$end_performance_period = $clin_l4_arr['data']['end_performance_period'];}
											?>
								...
								<div class="form-group">
									...
									<div class="col-md-6">							
										...
										if(isset($clin_l4_arr['data'])){$modification_number = $clin_l4_arr['data']['modification_number'];}
										?>	
								...
								<div class="form-group">
									...
									<div class="col-md-6">							
										...
										if(isset($clin_l4_arr['data'])){$modification_purpose = $clin_l4_arr['data']['modification_purpose'];}
										?>	
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l4_arr['data'])){$operating_unit_id = $clin_l4_arr['data']['operating_unit_id'];}
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l4_arr['data'])){$employee_id = $clin_l4_arr['data']['employee_id'];}
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										$do_not_share = ''; 
										if(isset($_REQUEST['do_not_share']))$do_not_share = $_REQUEST['do_not_share'];
										if(isset($clin_l4_arr['data'])){$do_not_share = $clin_l4_arr['data']['do_not_share'];}
										?>
						  ...
						  <?php } ?>			
								...
								<div class="form-group">
									<div class="col-md-6">
										<h5 class="pull-right"><a href="award_clin_l3.php">Back to Award CLIN - L3</a></h5>
									</div>
									<div class="col-md-6">
										<a href="" class="btn btn-default" style="margin-right:25px;">Cancel</a>
										<button type="submit" class="btn btn-primary save" name="save_clin_l4" >Save</button>
									</div>
								</div>					
