...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
   ...
   $select_fund_transaction = "select t.*,td2.ledger_type_id ,td1.ledger_type_id,sum(td2.debit_amount) as total_debit_amount
                        ...
                        where td2.ledger_type='".$ledger_type."' and td2.debit_amount is not null and td2.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td1.fund_status='Obligate' and td2.fund_status='Commit' ".$cond."  group by td2.ledger_type_id ";
