	...
	<div class="container-fluid">
		<div class="header-detail">
			<div class="head-title">
				<div class="head">Operating Unit <span class="pull-right">(<a href="archived_list.php">Back</a>)</span></div>
			</div>
			<div class="row clear details">
				<div class="col-md-12"><a href="manage.php" class="remove-line"><?php echo $operating_unit_arr['data']['operating_unit_description']; ?></a> >> <a href="framework_management.php" class="remove-line"> Framework Management</a> >> <a href="archived_list.php" class="remove-line"><?php echo $frame_status; ?></a> >> <?php echo ucfirst($frame_name); ?></div>
			</div>
		</div>
	</div>
	<!-- Adding Adding Frame -->
	<div class="add-frame">
		<div class="container-fluid">
			<div class="col-md-9" style="text-align: center;">
					...
					?>
				<h2 class="text-center" style="margin-top: 30px;"><?php echo ucwords($frame_name); ?> (<?php echo $frame_status; ?>) </h2>
			</div>
