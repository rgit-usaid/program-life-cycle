...
##generate CLIN number by requisition=========
function generateClinNumber($requisition_number)
{
	$url = API_HOST_URL."get_all_clin_l1_by_requisition.php?flag=1&requisition_number=".$requisition_number;
	$requisition_arr = requestByCURL($url);
	$total_count = count($requisition_arr['data']);
	$total_count  = $total_count + 1;
	$last_number = sprintf("%03d",$total_count);
	$clin_number = $requisition_number.'-'.$last_number;
	return $clin_number;
}

###get requisition number from request=========
$requisition_number = '';
$level = 1;
...
if($requisition_number!='')
{
	...
	$clin_number = generateClinNumber($requisition_number);	
}
...
if(isset($_REQUEST['edit_clin_l1']))
{
	...
	## get all assoc link for clin level 1 =======	
...
{
	$edit_clin_number = $_REQUEST['edit_clin_number'];
	removeRequisitionClin_l1($edit_clin_number);
	header("location:clin_l1.php");  
}
?>
				...
				<div class="col-md-6">
					<div class="container-fluid" id="manage-vendor">
						<div class="form-title" style="width:145px;">
							<i class="fa fa-minus" aria-hidden="true"></i>CLIN - L1
						</div>
						<div class="new-form-content">
							<div class="manage-info">				
								...
								<div class="form-group">
									<label for="start_performance_period" class="col-md-6 control-label">CLIN Start Performance Period:</label>
									<div class="col-md-6">
								...
								<div class="form-group">
									<label for="end_performance_period" class="col-md-6 control-label">CLIN End Performance Period:</label>
									<div class="col-md-6">
										<div class="input-group">
											<?php 
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l1_arr['data'])){$share = $clin_l1_arr['data']['share'];}
				...
				<div class="col-md-6 budget disp-none">
					<table id="local_vendor" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							...
							<tr>						
								<th class="text-center code-field">Cost Code</th>
							...
							{	
								...
								{		
									...
									<select class="form-control" name="code_description[]" onChange="getCodeDescription(this)"; >
													...
													<option value="Equipment=2002" <?php if($edit_clin_budget_arr['data'][$k]['code_description']=='Equipment') echo "selected"; ?>>Equipment (2002)</option>
...
<div class="container-fluid">
	<table id="manage-parent-table" class="table table-striped" border="2" cellspacing="0" width="100%">
		<thead>
			<tr>
		...
		<tbody>
			<?php
			for($k=0; $k<count($requisition_clin_l1_arr['data']); $k++)
			{
				$url = API_HOST_URL."get_all_budget_of_clin.php?clin_number=".$requisition_clin_l1_arr['data'][$k]['clin_number'];
				$clin_budget_arr = requestByCURL($url);
				
				$url = API_HOST_URL."get_link_to_by_requisition.php?requisition_number=".$requisition_clin_l1_arr['data'][$k]['clin_number'];
				$list_assoc_link_arr = requestByCURL($url);
				?>	
				<tr class="parent-tbl parent-link">
					<td class="text-center"><span onClick="showClinTwo(this)" class="btn action" title="Level-1"> <img src="images/plus.png"></span> <?php echo $requisition_clin_l1_arr['data'][$k]['clin_number']; ?></td>
					<td class="text-center"><?php echo $requisition_clin_l1_arr['data'][$k]['clin_name']; ?></td>
					<td class="text-center"><?php echo $requisition_clin_l1_arr['data'][$k]['clin_description']; ?></td>
					<td class="text-right"><?php echo '$'.number_format($requisition_clin_l1_arr['data'][$k]['clin_amount']); ?></td>
					<td class="text-center"><?php echo $requisition_clin_l1_arr['data'][$k]['start_performance_period']; ?></td>
					<td class="text-center"><?php echo $requisition_clin_l1_arr['data'][$k]['end_performance_period']; ?></td>
							...
							<ul class="list-inline" style="">
								<li>
									<form method="post" action="">
										<input type="hidden" name="edit_clin_number" value="<?php echo $requisition_clin_l1_arr['data'][$k]['clin_number'];?>">
								...
								<li>
									<form method="post" action="clin_l2.php">
										<input type="hidden" name="clin_l1_number" value="<?php echo $requisition_clin_l1_arr['data'][$k]['clin_number'];?>">
										<input type="hidden" name="requisition_number" value="<?php echo $requisition_number;?>">
										<button type="submit" class="btn btn-default action" data-toggle="tooltip" data-placement="top" title="CLIN - L2" style="margin:0 2px; color:#000; font-size: 12px; text-decoration:none"> CLIN - L2 </button>
									</form>
								</li>									
							</ul>
						</div>							
			...
			<tr class="child-clin2 disp-none">
							<td colspan="9">
								<div style="padding:10px;">
									...
									$url = API_HOST_URL."get_all_clin_l2_by_clin1.php?clin_l1_number=".$requisition_clin_l1_arr['data'][$k]['clin_number'];
