...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
	...
	$select_fund_transaction = "select t.*,ou.operating_unit_abbreviation,ou.operating_unit_description,td1.ledger_type_id,td2.ledger_type_id as op_id,td2.ledger_type as op_type,td1.ledger_type as project_type ,td1.credit_amount,td1.debit_amount
                        ...
                        where td2.ledger_type='Award CLIN' and td1.ledger_type='".$ledger_type."' and td1.ledger_type_id='".$ledger_type_id."'  and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td1.fund_status='Obligate'  and td2.fund_status='Commit' ".$cond."  group by t.id ";
    ...
    while($fetch_fund_transaction = $result_fund_transaction->fetch_array())
    {
         $data[$i]['ledger_type_id'] = $fetch_fund_transaction['ledger_type_id']; // for commit in type id
		  $data[$i]['project_type'] = $fetch_fund_transaction['project_type']; 
