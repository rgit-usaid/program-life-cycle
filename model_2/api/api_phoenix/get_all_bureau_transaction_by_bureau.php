...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
   ...
   $select_fund_transaction = "select t.*,td1.ledger_type_id,ou.operating_unit_abbreviation,ou.operating_unit_description,td1.credit_amount,td1.debit_amount,td2.ledger_type_id as origination_point
                        ...
                        where td1.ledger_type='Operating Unit' and td2.ledger_type='Program Element' and td1.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' ".$cond." order by t.id";
