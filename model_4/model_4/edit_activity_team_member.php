...
<body>
	...
	<div class="container-fluid">
		<ol class="breadcrumb">
			<li><a href=".">Home</a> &raquo; <a href="existing_project.php">Existing Project</a> &raquo; <a href="activity_list.php">Edit Activity Info</a> &raquo; <a href="manage_activity_team.php">Activity Team</a> &raquo; <a class="active">Edit Activity Team</a></li>
		</ol>
		<!-- Left Menu -->
		<div class="col-md-3">
			...
			<div class="wrap" style="min-height: 200px;">
				<div class="container-fluid">
					<form class="form-horizontal app_cdcs_no" action="" method="post">
						...
						<div>
							<div class="form_grp">
								<div class="blk_head">Current Team</div>
								<div>Anyone who has an active role in the activity. Anyone can edit the team.</div>
							</div>
							<div class="row form_grp">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
									<div class="img_blk">
										...
										<div>
											<button type="button" class="btn-sm">Edit</button> <button type="button" class="btn-sm usa-button-gray">Delete</button>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
