...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $data = array();
    $select_fund_transaction = "select t.*,ou.operating_unit_abbreviation,ou.operating_unit_description,td2.ledger_type_id ,td2.ledger_type,td1.credit_amount,td1.debit_amount,td2.fund_status
							...
							where td1.ledger_type='Operating Unit' and ou.type!='Bureau' and td1.credit_amount is not null and td1.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td2.fund_status='Commit' ".$cond." group by t.id ";
