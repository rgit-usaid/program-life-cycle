...
unset($_SESSION['archive_clin_l3_id']);
...
{
	$url = API_HOST_URL."get_all_award_clin_l3_by_clin2.php?flag=1&clin_l2_number=".$clin_l2_number;
	$clin_arr = requestByCURL($url);
...
if(isset($_REQUEST['save_clin_l3']))
{
	...
	else
	{
		if($clin_id=='')
		{
			...
			header("location:award_clin_l3.php");
		}
		else
		{
...
### get header details or clin level 3 details for listing=======
if($award_number!='')
{
...
if(isset($_REQUEST['edit_clin_l3']))
{
	...
	## get all assoc link for award clin level 3 =======	
...
{
	$edit_clin_number = $_REQUEST['edit_clin_number'];
	removeAwardClin_l3($edit_clin_number);
	header("location:award_clin_l3.php");  
}
?>
<!DOCTYPE html>
		...
		<table id="manage-parent-table" class="table table-striped" border="2" style="" cellspacing="0" width="100%">
			...
			<tbody>
				...
				if(count($award_clin_l3_arr['data'])>0)
				{
					...
					{
						$url = API_HOST_URL."get_all_budget_of_clin.php?clin_number=".$award_clin_l3_arr['data'][$k]['clin_number'];
						$clin_budget_arr = requestByCURL($url);
						
						$url = API_HOST_URL."get_link_to_by_requisition.php?requisition_number=".$award_clin_l3_arr['data'][$k]['clin_number'];
						$list_assoc_link_arr = requestByCURL($url);
						?>	
						<tr class="parent-tbl parent-link">
							<td class="text-center"><span onClick="showClinTwo(this)" class="btn action" title="Level-3"><img src="images/plus.png"></span> <?php echo $award_clin_l3_arr['data'][$k]['clin_number']; ?></td>
							<td class="text-center"><?php echo $award_clin_l3_arr['data'][$k]['clin_name']; ?></td>
							<td class="text-center"><?php echo $award_clin_l3_arr['data'][$k]['clin_description']; ?></td>
							<td class="text-right"><?php echo '$'.number_format($award_clin_l3_arr['data'][$k]['clin_amount']); ?></td>
							<td class="text-center"><?php echo $award_clin_l3_arr['data'][$k]['start_performance_period']; ?></td>
							<td class="text-center"><?php echo $award_clin_l3_arr['data'][$k]['end_performance_period']; ?></td>
									...
									<ul class="list-inline" style="">
										<li>
											<form method="post" action="">
												<input type="hidden" name="edit_clin_number" value="<?php echo $award_clin_l3_arr['data'][$k]['clin_number'];?>">
										...
										<li>
											<form method="post" action="award_clin_l4.php">
												<input type="hidden" name="clin_l3_number" value="<?php echo $award_clin_l3_arr['data'][$k]['clin_number'];?>">
												...
												<button type="submit" class="btn btn-default action" data-toggle="tooltip" data-placement="top" title="AWARD CLIN - L4" style="margin:0 2px; color:#000; font-size: 12px; text-decoration:none"> AWARD CLIN - L4 </button>
											</form>
											<?php 
											 $url = API_HOST_URL."get_all_archive_award_clin_detail.php?archive_clin_id=".$award_clin_l3_arr['data'][$k]['clin_id'];
											 $archive_award_req_arr = requestByCURL($url); if(count($archive_award_req_arr['data'])>0) { ?>
											<a href="award_clin_l3_archive_list.php?archive_clin_l3_id=<?php echo $award_clin_l3_arr['data'][$k]['clin_id'];?>">Change Log</a>
			...
			<form class="form-horizontal" role="form" method="post" action="">			
				...
				<div class="col-md-6">
					<div class="container-fluid" id="manage-vendor">
						<div class="form-title" style="width:300px;">
							<i class="fa" aria-hidden="true"></i>AWARD CLIN - L3
						</div>
							...
							<div class="manage-info">				
								...
								<div class="form-group">
									...
									<div class="col-md-6">							
										...
										if(isset($clin_l3_arr['data'])){$modification_number = $clin_l3_arr['data']['modification_number'];}
										?>	
								...
								<div class="form-group">
									...
									<div class="col-md-6">							
										...
										if(isset($clin_l3_arr['data'])){$modification_purpose = $clin_l3_arr['data']['modification_purpose'];}
										?>	
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l3_arr['data'])){$operating_unit_id = $clin_l3_arr['data']['operating_unit_id'];}
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										if(isset($clin_l3_arr['data'])){$employee_id = $clin_l3_arr['data']['employee_id'];}
								...
								<div class="form-group">
									...
									<div class="col-md-6">								
										...
										$do_not_share = ''; 
										if(isset($_REQUEST['do_not_share']))$do_not_share = $_REQUEST['do_not_share'];
										if(isset($clin_l3_arr['data'])){$do_not_share = $clin_l3_arr['data']['do_not_share'];}
										?>
							  ...
							  <?php } ?>		
								...
								<div class="form-group">
									<div class="col-md-6">
										<h5 class="pull-right"><a href="award_clin_l2.php">Back to Award CLIN - L2</a></h5>
									</div>
									<div class="col-md-6">
