...
<body>
	...
	<div class="container-fluid">
		<ol class="breadcrumb">
			<li><a href=".">Home</a> &raquo; <a href="existing_project.php" class="active">Existing Project</a> &raquo; <a href="project_info.php" class="active">Edit Project Info</a> &raquo; <a class="active">Project Detail</a></li>
		</ol>
		<!-- Left Menu -->
		<div class="col-md-3">
				...
				<div class="container-fluid">
					<form class="form-horizontal project_design_plan" action="" method="post">
						<div  class="form_grp" style="padding:20px 0px; font-size:16px;">
							...
							<div>Activities scheduled for concurrent design are located on the Activtiy Tab</div>
						</div>
						<div class="form_grp">
							...
							<div>
								<select id="project_stage">
									...
									<option value="2" selected="selected">Project Design Plan</option>
	...
	<script>
		$('#project_stage').change(function(){
			...
			if(stage>2){
				$('form').attr('action','manage_project_appraisal_document.php');
				$('form').submit();
			}
			else{
				$('form').attr('action','manage_project_design_plan.php');
				$('form').submit();
			}	
		});
		
		$('#proceed').click(function(){
			window.location = "manage_project_appraisal_document.php";
		});
	</script>
</body>
</html>