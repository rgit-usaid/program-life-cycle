...
<body>
	...
	<div class="container-fluid">
		<ol class="breadcrumb">
			<li><a href=".">Home</a> &raquo; <a href="existing_project.php">Existing Project</a> &raquo; <a href="activity_list.php">Edit Activity Info</a> &raquo; <a class="active">Activity Finance</a></li>
		</ol>
		<!-- Left Menu -->
		<div class="col-md-3">
				...
				<div class="container-fluid">
					<form class="form-horizontal app_cdcs_no" action="" method="post">
						<div  class="form_grp" style="padding:20px 0px; font-size:16px;">
							<h3 class="form-blk-head" style="margin-top:0px; font-weight:bold;">Manage Activity Finance</h3>
							<hr>
						</div>
						...
						<div>
							<table>
								<tr>
									...
									<td>Available</td>
									<td>Forecast</td>
									<td style="width:40px">Buttons</td>
								</tr>
								<tr>
									<td>2018-19</td>
									<td>$100,000</td>
									...
									<td>$0</td>
									<td>
										<button type="button" class="btn-sm usa-button-gray">Forecaster</button> <button type="button" class="btn-sm usa-button-gray">Planner</button> 
									</td>
								</tr>
							</table>
						</div>
		...
		<div class="col-md-3">
			<div class="wrap-right-menu">
				<div id="help">
					...
					<hr>
					<div class="blk">
						Please use Phoenix to manage financial and accounting data for activities. <br/>
	...
	<script>
		...
		$('#proceed').click(function(){
			window.location = "manage_activity_procurement.php";
		});
