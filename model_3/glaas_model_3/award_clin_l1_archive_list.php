...
## get id archive award clin level-1 for archive details================
if($_REQUEST['archive_clin_l1_id']!='')
{
	$archive_clin_l1_id = $_REQUEST['archive_clin_l1_id'];
	$_SESSION['archive_clin_l1_id'] = $archive_clin_l1_id;
}
else
{
	$archive_clin_l1_id = $_SESSION['archive_clin_l1_id'];
}
	$url = API_HOST_URL."get_all_archive_award_clin_detail.php?archive_clin_id=".$archive_clin_l1_id;
...
<div class="container-fluid" id="form-requisiton">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-right btnstyle"> <a href="award_clin_l1.php">
      <button type="button" class="btn btn-primary back_button">Back to Award Clin -L-1</button>
      </a> </div>
  </div>
                ...
                <form class="form-horizontal" role="form" method="post" action="">
                  <div class="col-md-6">
                    <div class="container-fluid" id="manage-vendor">
                      <div class="form-title" style="width:200px;"> <i class="fa fa-minus" aria-hidden="true"></i>AWARD CLIN - L1 </div>
                      <div class="new-form-content">
                        <div class="manage-info">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="text" name="end_performance_period" value="" readonly="<?php echo $archive_clin_arr['data'][$k]['modification_purpose']; ?>" class="form-control">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="req_link_to" style="width:100%">
                            ...
                            <div class="form-group associate" style="display: block;">
							  ...
							  <?php
								...
								$url = AMP_API_HOST_URL."get_project.php?project_id=".$archive_assoc_link_arr['data'][$l]['link_to_id'];
				...
				<?php 	 } 
                            ...
                            <div class="form-group associate" style="display: block;">
							  ...
							  ?>
								...
								<?php
								### get project from HR Connect===============
								$url = AMP_API_HOST_URL."get_project.php?project_id=".$project;
								$project_arr = requestByCURL($url); 
							 	 ?>
                                  <option value="000064" selected="selected"><?php echo $project_arr['data']['title'].' ('.$project_arr['data']['project_id'].')'; ?></option>
                                </select>
							...
							<div class="form-group associate" style="display: block;">
                              ...
                              <div class="col-md-6">
								...
								<?php
									...
									$url = AMP_API_HOST_URL."get_project_activity.php?project_id=".$project."&activity_id=".$archive_assoc_link_arr['data'][$l]['link_to_id'];
