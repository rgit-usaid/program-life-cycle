	...
	<div class="main-container container-fluid" id="main-content">
		<div>
			...
			<div class="tbl-block">
				...
				<div class="tbl-content-head">
					<?php 
						if($flag_stage_doc==2){
							echo "You are viewing project details"; 
						}
						else if($project_id!=""){ 
							echo "You are editing project details"; 
						} 
						else 	
						echo "Add New Project Details";
					?>
				</div>
				<div class="clear"></div>
			</div>
			...
			<div class="project-detail-blk table-container">
				<?php if($project_id!="" && $flag_stage_doc==2){ ?>
				<div class="row project-detail-textarea">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>Project Appraisal Plan is here</label><br/>
									<a class="pointer" href="add_new_project"><i class="fa fa-link" aria-hidden="true"></i> Project Appraisal Plan</a>
							<input type="hidden" value="2" name="view_only_mode"/>
						</div>
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
							<a href="view_project_design_plan_archive.php">Project Design plan Change Log</a>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
				<?php }elseif($project_id!="" && $flag_stage_doc!=2){?>
				<div class="row project-detail-textarea">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
						</div>
				...
				<div class="form-blk">
					...
					<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<?php } else {?>
							<input type="text" value="<?php echo $project_arr['data']['stage_name'];?>"  disabled="disabled"/>
							<?php }?>
							</div>
							<div class="clear"></div>
							<?php } ?>
					...
					<div class="row project-detail-textarea">
						...
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<textarea class="form-textarea  sm project_title autoh_textarea"   name="title" rows="1" placeholder="Project Title" <?php if($flag_stage_doc==2) {?> disabled <?php }?>><?php echo $project_title;?></textarea>
						</div>
						<?php
							...
							if(isset($project_arr)) {
								...
								$operating_unitinfo_url = API_HOST_URL_PHOENIX."get_operating_unit_by_id.php?operating_unit_id=".$originating_operating_unit_id;  
						...
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<label>Originating Operating Unit : </label><br/>
								<div class="search_div" style="position:relative">
									<input type="text" name="originating_operating_unit" class="search_txt form-control" autocomplete="off" onKeyUp="search_val(this,'<?php echo API_HOST_URL_PHOENIX;?>get_all_operating_unit.php')" value="<?php echo $operating_unitinfo_desc;?>" <?php if($flag_stage_doc==2) {?> disabled <?php }?>/>
					...
					<?php
						...
						if(isset($project_arr)) {
							...
							$estimated_total_funding_amount = "$".number_format($estimated_total_funding_amount);
						}
					?>
					<div class="row project-detail-textarea">
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<input type="text" class="maxw_350 money_format amount_type" name="estimated_total_funding_amount" placeholder="Estimated of Total USAID Project Funding Needed" <?php if($flag_stage_doc==2) {?> disabled <?php }?> value="<?php echo $estimated_total_funding_amount;?>"/>
							</div>
						</div>
						<?php
							...
							if(isset($project_arr)) {
								...
								$implementing_unitinfo_url = API_HOST_URL_PHOENIX."get_operating_unit_by_id.php?operating_unit_id=".$implementing_operating_unit_id;  
						...
						<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<label>Implementing Operating Unit : </label><br/>
								<div class="search_div" style="position:relative">
									<input type="text" name="implementing_operating_unit" class="search_txt form-control" autocomplete="off" onKeyUp="search_val(this,'<?php echo API_HOST_URL_PHOENIX;?>get_all_operating_unit.php')" value="<?php echo $implementing_unitinfo_desc;?>" <?php if($flag_stage_doc==2) {?> disabled <?php }?>/>
					...
					<div class="row project-detail-textarea">
						<div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<textarea class="form-textarea sm project_purpose autoh_textarea" name="project_purpose" rows="2" placeholder="Project Purpose" <?php if($flag_stage_doc==2) {?> disabled <?php }?>><?php echo $project_purpose;?></textarea>
						</div>
					</div>
					<?php
					...
					<div class="row project-detail-textarea">
						<div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<textarea class="form-textarea sm autoh_textarea" name="engaging_local_actor_plan" rows="2" placeholder="Plan for Engaging Local Actors" <?php if($flag_stage_doc==2) {?> disabled <?php }?>><?php echo $engaging_local_actor_plan;?></textarea>
						</div>
					</div>
					<?php
					...
					<div class="row project-detail-textarea">
						<div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<textarea class="form-textarea sm autoh_textarea" name="conducting_analyses_plan" rows="2" placeholder="Plan for Conducting Analyses" <?php if($flag_stage_doc==2) {?> disabled <?php }?>><?php echo $conducting_analyses_plan;?></textarea>
						</div>
					</div>
					<?php
					...
					<div class="row project-detail-textarea">
						<div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<textarea class="form-textarea sm autoh_textarea" name="use_of_govt_to_govt_plan" rows="2" placeholder="Plan for Possible Use of Govt to Govt" <?php if($flag_stage_doc==2) {?> disabled <?php }?>><?php echo $use_of_govt_to_govt_plan;?></textarea>
						</div>
					</div>
					<?php
					...
					<div class="row project-detail-textarea">
						<div  class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							...
							<input type="hidden" value="<?php echo $proposed_design_schedule;?>" class="actual_smartsheet_link"/>
						   	<input type="text" class="maxw_350  <?php if($flag_stage_doc!=2) {?> disp-none <?php }?> " id="smart_sheet_ip" value="<?php echo $proposed_design_schedule;?>" name="proposed_design_schedule" placeholder="Proposed Design Schedule"   <?php if($flag_stage_doc==2) {?> disabled <?php }?>/>
							...
							<?php if($flag_stage_doc!=2) {?>
								<button class="disp-none usa-button-outline" id="cancel_smartsheet_link" type="button">Cancel</button> 
								<button id="edit_smartsheet_link" type="button"><?php if($proposed_design_schedule==""){ ?> Add Smartsheet Link <?php } else {?> Edit Link <?php }?></button> 
							<?php }?>
						...
						<?php
							...
							if(isset($project_arr)) {
								...
								$proposed_design_cost = "$".number_format($proposed_design_cost);
							}
						?>
						<div  class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="validate_ip_par">
							<label>Proposed Design Cost</label><br/>
							<input type="text" class=" maxw_350 money_format amount_type"  value="<?php echo $proposed_design_cost;?>" name="proposed_design_cost" placeholder="Proposed Design Cost" <?php if($flag_stage_doc==2) {?> disabled <?php }?>/>
							</div>
						</div>	
					</div>
					<!--<div class="ip-outer">
...
<?php 
##==expand all textare in view only mode===
if($flag_stage_doc==2) {?> 
<script>
...
$( "#find" ).autocomplete({
  source: function( request, response ) {
	$.ajax( {
	  url: "<?php echo API_HOST_URL_PHOENIX;?>get_all_operating_unit.php",
	  dataType: "jsonp",
	  data: {
