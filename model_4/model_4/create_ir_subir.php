...
<body onLoad="init()">
	...
	<div class="container-fluid">
		...
		<div class="col-md-6">
			<div class="wrap">
				<div class="container-fluid">
					<a href="no_framework_found.php" class="pull-right">No Framework Found</a>
					<div id="sample">
					...
					<div>
						<input type="button" class="usa-button-hover" value="Proceed" id="proceed"/>
					</div>
				</div>
			</div> 
		</div>
		...
		<div class="col-md-3">
			<div class="wrap-right-menu">
				<div id="help">
					...
					<hr>	
					<p class="blk">	Creating a simple project design is the process by which USAID defines how it will operationalize a result or set of results in a CDCS or other strategic framework to ensure that efforts are complementary and aligned in support of the strategy. Whereas the strategic planning process defines the strategic approach, the project design process guides its execution. </p>
				</div>
			</div>
		</div>
	</div>
