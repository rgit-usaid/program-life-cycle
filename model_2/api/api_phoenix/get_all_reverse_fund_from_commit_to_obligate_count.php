...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $data = array();
    $select_fund_transaction = "select t.*,sum(td1.credit_amount) as total_reverse_amount
                        ...
                        where  td1.ledger_type='".$ledger_type."' and td2.ledger_type='Project Activity' and td1.credit_amount is not null and td1.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td1.fund_status='Commit' and td2.fund_status='Obligate' ".$cond."  group by td1.ledger_type_id";
    ...
    {
        $data[$i]['total_reverse_amount'] = $fetch_fund_transaction['total_reverse_amount'];  
