...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $select_fund_transaction = "select t.*,td.ledger_type_id,td.ledger_type
                        from usaid_fund_transaction as t
                        left join usaid_fund_transaction_detail as td ON td.transaction_id = t.id
                        where td.ledger_type_id='".$ledger_type_id."' and ledger_type='Project Activity' and fund_status='Obligate' and td.credit_amount is not null group by td.ledger_type_id,t.fund_id,t.fund_beginning_fiscal_year,t.fund_ending_fiscal_year,t.program_element_id";                   
