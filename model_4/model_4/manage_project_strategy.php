...
<body onLoad="init()">
	...
	<div class="container-fluid">
		<ol class="breadcrumb">
			<li><a href=".">Home</a> &raquo; <a href="existing_project.php">Existing Project</a> &raquo; <a href="project_info.php">Edit Project Info</a> &raquo; <a class="active">Strategy</a></li>
		</ol>
		<!-- Left Menu -->
		<div class="col-md-3">
