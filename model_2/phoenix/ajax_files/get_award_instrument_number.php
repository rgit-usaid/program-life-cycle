...
if(isset($_REQUEST['vendor_id']))
{
	...
	if($vendor_id!='')
	{
		...
		$url = GS_API_HOST_URL."get_all_award_instrument_number.php?vendor_id=".$vendor_id."&project_id=".$project_id."&operating_unit_id=".$operating_unit_id."";
		$all_award_number_arr = requestByCURL($url);	
		?> 
		<select class="form-control award_number" name="award_instrument_no" onChange="getAwardNumber(this)";>
