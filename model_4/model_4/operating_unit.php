		...
		<div class="col-md-6">
			<div class="wrap">
				<div class="container-fluid" style="margin:10px 0">
					<form class="usa-form" method="post" action="existing_ou_project.php">
						<label for="options">Select Operating Unit</label>
						<select name="options" id="options">
							<option value="">Select</option>
							<option value="value1">AFR (Bureau of Africa)</option>
						</select>
						<input type="submit" value="Go">
					</form>
				</div>
				<div class="container-fluid project_list" style="display: none;">
