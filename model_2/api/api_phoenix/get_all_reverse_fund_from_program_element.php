...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $data = array();
    $select_fund_transaction = "select t.*,td1.ledger_type_id ,td1.credit_amount,td1.debit_amount,f.fund_name,td2.ledger_type_id as debit_from_id
                            ...
                            where td1.ledger_type='Fund' and td2.ledger_type='Program Element' and td1.credit_amount is not null  and td1.ledger_type_id='".$ledger_type_id."' ".$cond." group by t.id ";
