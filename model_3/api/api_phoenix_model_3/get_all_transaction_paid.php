...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    if(isset($_REQUEST['b_year']) and isset($_REQUEST['e_year']) and $_REQUEST['b_year']!='' and $_REQUEST['e_year']!='')
    {
	 ...
	 $select_fund_transaction = "select t.*,ou.operating_unit_abbreviation,ou.operating_unit_description,td1.ledger_type_id,td1.ledger_type,td1.credit_amount,td1.debit_amount
                        ...
                        where td2.ledger_type='".$ledger_type."' and td1.ledger_type='".$ledger_type."' and td1.ledger_type_id='".$ledger_type_id."'  and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td1.fund_status='Paid'  and td2.fund_status='Obligate' ".$cond."  group by t.id ";
