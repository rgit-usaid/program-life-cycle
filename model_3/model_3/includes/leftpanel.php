<div class="leftpanel">
	<ul>
		...
		<li class="crosslink">
		  <a href="#" style="background-image:url('<?php echo SITE_PATH;?>usaid/amp/2/img/money.png'); background-position:10px; background-size:20px; background-repeat:no-repeat; padding-left:30px"> Phoenix</a>
		</li>
		<li class="crosslink">
