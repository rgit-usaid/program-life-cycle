...
$select_fund_transaction = "select t.*,td.ledger_type_id ,sum(td.credit_amount) as total_amount,td.ledger_type,f.fund_id as fund_code
                        ...
                        where td.fund_status='Obligate' and td.credit_amount is not null group by td.ledger_type_id,t.fund_beginning_fiscal_year,t.fund_ending_fiscal_year,t.fund_id,t.program_element_id";
