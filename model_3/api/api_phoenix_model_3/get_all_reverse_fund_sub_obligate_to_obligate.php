...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $data = array();
    $select_fund_transaction = "select t.*,td2.ledger_type_id,td1.ledger_type_id as op_id,td1.ledger_type as op_type,td2.ledger_type,td1.credit_amount,td1.debit_amount,td2.fund_status
                        ...
                        where  td1.ledger_type='".$ledger_type."' and td1.credit_amount is not null and td1.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' and t.program_element_id='".$pe_id."' and td1.fund_status='Obligate' and td2.fund_status='Subobligate' ".$cond."  group by t.id ";
