...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
   ...
   $select_fund_transaction = "select t.*,td1.ledger_type_id ,f.fund_id as fund_code,f.fund_name,td1.credit_amount,td1.debit_amount,td2.ledger_type_id as origination_point
                        ...
                        where td1.ledger_type='Program Element' and td2.ledger_type='Fund' and td1.ledger_type_id='".$ledger_type_id."' and t.fund_id='".$fund_id."' ".$cond." order by t.id";
