...
if(isset($_REQUEST['ledger_type_id']) and $_REQUEST['ledger_type_id']!='')
{
    ...
    $select_fund_transaction = "select t.*,f.fund_name,td.ledger_type_id,td.credit_amount,td.debit_amount,op.origination_point_name
                        ...
                        left join usaid_fund as f ON f.id = td.ledger_type_id where td.ledger_type='Fund' and td1.ledger_type='Origination Point' and td.ledger_type_id='".$ledger_type_id."' ".$cond."  group by t.id ";
